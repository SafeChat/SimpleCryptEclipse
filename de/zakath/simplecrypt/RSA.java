...
public class RSA
{
     ...
     *
     * @param input The byte array that should be signed
     ...
     *
     * @param input The signed byte array. First 256 byte must be signature,
     * followed byte signed data
     * @return A verifyresult, consisting of a boolean indicating if verfiying
     * was successful and a byte array containig the data which was singed. For
     * more informations see {@link VerifyResult}.
     *
     */
     ...
     *
     * @param input The byte array that should be encrypted. Be aware: Maximum
    ...
    public class VerifyResult
    {
         ...
         * @param wasSuccessful A boolean which indicates whether the verification was successful or not.
         * @param data A byte array which holds signed data without singed bytes.
         */
